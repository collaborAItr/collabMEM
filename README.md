...
> Project presents ACT-R, a cognitive architecture that models human cognition as a set of modular, interacting systems governing memory, perception, and action. The book argues that complex thought can be decomposed into discrete, "atomic" cognitive operations governed by rational principles, supported by computational simulations and empirical psychological data.
